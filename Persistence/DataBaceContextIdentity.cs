...
{
    public  class DataBaceContextIdentity: IdentityDbContext<User>, IDataBaceContextIdentity
    {
        public DataBaceContextIdentity(DbContextOptions<DataBaceContextIdentity> options) : base(options)
        {
