...
namespace EndPointOnlineShop.Models.VIewModel
{
    public class RejesterViewModel
    {
        ...
        [MinLength(10, ErrorMessage = "نام و نام خانوادگی نباید بیش از 100 کاراکتر باشد")]
        public string FullName { get; set; }

        [Required(ErrorMessage = "ایمیل را وارد نمایید")]
        [EmailAddress(ErrorMessage ="موتبر نیس")]
